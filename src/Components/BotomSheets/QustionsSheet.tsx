  ...
  const QuestionSheet = ({ sheetRef, contentTitles, onContentSelect }: Props) => {
    ...
    return (
      <View style={[GlobalStyleSheet.container, { paddingTop: 0, backgroundColor: "#ef6a77", paddingBottom: 50 ,borderTopLeftRadius:15, borderTopRightRadius:15  }]}>
        <View style={[styles.filterBackground, { borderBottomColor: COLORS.inputborder, borderStyle: 'dashed' }]}>
          <Text style={[FONTS.fontRegular, { color: COLORS.white, fontSize: 18 }]}>Questions</Text>
          <TouchableOpacity
          ...
          >
            ...
            <Text style={[FONTS.fontRegular, { fontSize: 12, paddingLeft: 5 }]}>Close</Text>
          </TouchableOpacity>
        </View>
