...
auto module_ReactNativeBlobUtilSpec = ReactNativeBlobUtilSpec_ModuleProvider(moduleName, params);
if (module_ReactNativeBlobUtilSpec != nullptr) {
return module_ReactNativeBlobUtilSpec;
}
...
auto module_HtmlToPdfSpec = HtmlToPdfSpec_ModuleProvider(moduleName, params);
if (module_HtmlToPdfSpec != nullptr) {
return module_HtmlToPdfSpec;
}
